...
import ConfDashbord from "./components/Spesific__Components/User_conf_pages/ConfDashbord/ConfDashbord";
    ...
    <UserContext.Provider value={value}>
      <div className="App">
        <BrowserRouter>
          ...
               
          <PrivateRoute exact path="/profile/myConf/:id" component={ConfDashbord} />
