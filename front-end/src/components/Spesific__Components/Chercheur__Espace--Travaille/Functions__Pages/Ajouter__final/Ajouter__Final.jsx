...
function Ajouter__Final({ match }) {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("http://localhost:3000/Article", Article__info, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: `Bearer ${user.token}`,
            ...
            <div className="module-inner">
              ...
              <div className="content-panel marginbuttom">
                <div className="header__Title">
                  <p className="header__Title__font">
                    {" "}
                    Ajouter la Version Finale{" "}
                  </p>
                  <div className="souliner"></div>
                </div>
                <div class="alert alert-danger" role="alert">
                  <span className="fas fa-exclamation-circle"></span> Cette
                  version d’article est  la version finale.
                </div>
                <div className="container contact-form">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group div__style">
                      ...
                      {errors.auteures && (
                        <p className="span__errors">
                          {errors.auteures?.message}
                        </p>
                      )}
                    </div>
                    <div className="form-row div__style mt-5">
                      ...
                      <div className="form-group col-md-6">
                        ...
                        />
                        {/* errors will return when field validation fails  */}
                        {errors.titre__Article && (
                          <p className="span__errors">
                            {errors.titre__Article?.message}
                          </p>
                        )}
                      </div>
                    </div>
                    <div className="form-group div__style">
                      ...
                      {/* errors will return when field validation fails  */}
                      {errors.mots && (
                        <p className="span__errors">{errors.mots?.message}</p>
                      )}
                    </div>
