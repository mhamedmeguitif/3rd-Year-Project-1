...
function PublicConf() {
  ...
  function AfficherConf() {
    axios
      .get(`http://localhost:3000/conferences/${id}`, {
        headers: {
  ...
  useEffect(()=>{
    console.log('test My conférences')
  }, [])
                          ...
                          <div className="item-box-blog-body">
                            ...
                            <div className="item-box-blog-data">
                              <p>
                                ...
                                <i className="fa fa-comments-o"></i> Comments(3)
                              </p>
                            </div>
                            ...
                            <div className="mt">
                              ...
                              <a
                                ...
                                tabindex="0"
                                className="btn bg-blue-ui white read"
                              >
                                read more
                              </a>{" "}
                            </div>
    ...
    <div>
      ...
      <div className="container">
          ...
          <div className="col">
            ...
            <Card style={{ width: "28rem", float: "right" }}>
              <Card.Body>
                ...
                <Card.Text>{conf.TheDeadline}</Card.Text>
                <br></br>
                <Card.Subtitle
                  className="mb-2 text-muted"
                  style={{ fontSize: 20 }}
        ...
        <div className="text-center">
          ...
          <br></br>
          <p style={{ fontSize: 20 }}> {conf.OpportunityInformation}</p>{" "}
          <br></br> <br></br>
        </div>
