...
.then( (res) =>{
  ...
  function EvalSubmit(evaluateur) {
    try{
   
         const t = [...ReadingCommitee,evaluateur];
     setReadingCommitee( [...ReadingCommitee,evaluateur]);
  ...
  <path fill-rule="evenodd" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4a.5.5 0 0 0-1 0v3.5H4a.5.5 0 0 0 0 1h3.5V12a.5.5 0 0 0 1 0V8.5H12a.5.5 0 0 0 0-1H8.5V4z"/>
               ...
               <br></br>
                ...
                <div className="input-group form-group">
                    ...
                    <DropdownButton id="dropdown-item-button" title="Show All users   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;" variant="light"> 
                    
                        {users.map((evaluateur,index) => (
                        <Dropdown.Item key= {index} style={{color:'black'}}>{evaluateur.Email}   <button type="button" class="btn btn-danger" onClick={()=>EvalSubmit(evaluateur)} >Add</button></Dropdown.Item>
                    ...
                    &nbsp;&nbsp; &nbsp;
                      <DropdownButton id="dropdown-item-button" title="Show reading commity" variant="secondary"> 
                        ...
                        <Dropdown.Item key= {index} style={{color:'black'}}>{evaluateur.Email} <button className="btn btn-outline-danger" onClick={() => removeEva(index)}>x</button> </Dropdown.Item>
                ...
                <div className="form-group">
                    <input type="submit" value="Add Conference" className="btn float{errR} ERROR try again -right login_btn"/>
                    {success && <div style={{color:'white'}}>your conference is added !</div>}
                </div>
            </form>
        </div>
